package com.kiwiko.jdashboard.webapp.mvc.requests.api.annotations;
...
public @interface RequestBodyParameter {
     ...
     * If it's required and not present, throws a {@link com.kiwiko.jdashboard.webapp.mvc.requests.api.RequestError}.
     ...
     * @throws com.kiwiko.jdashboard.webapp.mvc.requests.api.RequestError if required and not present
     */
