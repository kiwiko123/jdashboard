...
public class ResponseBuilder {
    ...
    public ResponsePayload build() {
        com.kiwiko.jdashboard.webapp.mvc.json.internal.data.ResponsePayload payload = new com.kiwiko.jdashboard.webapp.mvc.json.internal.data.ResponsePayload(body, errors, status.value());
