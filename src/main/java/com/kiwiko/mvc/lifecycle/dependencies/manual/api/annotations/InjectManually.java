 ...
 * {@link com.kiwiko.mvc.lifecycle.dependencies.manual.data.InjectManuallyConfigurer#create()}.
 *
 * The annotated field's type must have a default constructor in order to be successfully initialized.
 *
 * Any error during manual injection will yield a {@link com.kiwiko.mvc.lifecycle.dependencies.manual.api.errors.ManualInjectionException}.
 *
