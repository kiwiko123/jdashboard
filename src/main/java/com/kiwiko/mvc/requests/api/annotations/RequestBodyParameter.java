package com.kiwiko.mvc.requests.api.annotations;
...
public @interface RequestBodyParameter {
     ...
     * If it's required and not present, throws a {@link com.kiwiko.mvc.requests.api.RequestError}.
     ...
     * @throws com.kiwiko.mvc.requests.api.RequestError if required and not present
     */
