...
public class ClassProcessor {
    ...
    public void process(Class<?> clazz) {
        ...
        try {
            ...
            handleException(e, ClassProcessorStage.CLASS);
        }
        ...
        try {
            ...
            handleException(e, ClassProcessorStage.FIELDS);
        }
        ...
        try {
            ...
            handleException(e, ClassProcessorStage.METHODS);
        }
    }

    protected void handleException(Exception exception, ClassProcessorStage stage) { }
