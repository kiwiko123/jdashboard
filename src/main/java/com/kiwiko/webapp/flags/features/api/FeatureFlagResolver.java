...
public interface FeatureFlagResolver {
     ...
     * {@link com.kiwiko.webapp.flags.features.dto.FeatureFlagUserScope#INDIVIDUAL} feature flag.
     *
     * If no user ID is provided, search for a single matching
     * {@link com.kiwiko.webapp.flags.features.dto.FeatureFlagUserScope#PUBLIC} feature flag.
     *
