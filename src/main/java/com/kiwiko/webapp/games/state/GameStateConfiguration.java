package com.kiwiko.webapp.games.state;

import com.kiwiko.webapp.games.state.api.GameStateService;
import com.kiwiko.webapp.games.state.internal.GameStateEntityPropertyMapper;
import com.kiwiko.webapp.games.state.internal.GameStateEntityService;
import com.kiwiko.webapp.games.state.internal.UserGameStateAssociationEntityFieldMapper;
import com.kiwiko.webapp.games.state.internal.UserGameStateAssociationEntityService;
import com.kiwiko.webapp.games.state.internal.UserGameStateAssociationService;
import com.kiwiko.webapp.games.state.internal.dataAccess.GameStateEntityDAO;
